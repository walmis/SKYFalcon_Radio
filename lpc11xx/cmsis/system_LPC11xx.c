...
///
///http://www.lpcware.com/content/nxpfile/lpc11xx-main-pll-calculator
//#define SYSPLLCTRL_Val        (PSEL(2) | MSEL(4))
#define SYSPLLCTRL_Val        0x22  //16MHz crystal -> 48Mhz out
///
...
#if (CHECK_RSVD((AHBCLKCTRL_Val),  0xF2720000))
